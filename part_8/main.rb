    ...
    case train.type
      when :passenger
        ...
        if input >= 40 && input <= 80
          ...
          raise ArgumentError, "Введено неправильное значение количества мест. Используйте числа от 40 до 80"
        end
      when :cargo
        ...
        if input >= 80 && input <= 150
          ...
          raise ArgumentError, "Введено неправильное значение вместимости грузового вагона. Используйте числа от 80 до 150"
        end
    end
